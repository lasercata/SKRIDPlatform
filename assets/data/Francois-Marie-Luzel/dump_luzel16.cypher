...
CREATE (njc6hqr_luzel16_mei:Event {inputfile: 'luzel16_mei', source:'luzel16.mei' ,id:'njc6hqr' ,type: 'note' ,instrument:'Piano', duration: 0.125, pos:0.0, start:0.0, end:0.125}) 
...
CREATE (ndq58zu_luzel16_mei:Event {inputfile: 'luzel16_mei', source:'luzel16.mei' ,id:'ndq58zu' ,type: 'note' ,instrument:'Piano', duration: 0.125, pos:0.125, start:0.125, end:0.25}) 
...
CREATE (nit31al_luzel16_mei:Event {inputfile: 'luzel16_mei', source:'luzel16.mei' ,id:'nit31al' ,type: 'note' ,instrument:'Piano', duration: 0.125, pos:0.25, start:0.25, end:0.375}) 
...
CREATE (nrpu9ei_luzel16_mei:Event {inputfile: 'luzel16_mei', source:'luzel16.mei' ,id:'nrpu9ei' ,type: 'note' ,instrument:'Piano', duration: 0.125, pos:0.375, start:0.375, end:0.5}) 
...
CREATE (n16n0n31_luzel16_mei:Event {inputfile: 'luzel16_mei', source:'luzel16.mei' ,id:'n16n0n31' ,type: 'note' ,instrument:'Piano', duration: 0.25, pos:0.5, start:0.5, end:0.75}) 
...
CREATE (n67iauc_luzel16_mei:Event {inputfile: 'luzel16_mei', source:'luzel16.mei' ,id:'n67iauc' ,type: 'note' ,instrument:'Piano', duration: 0.125, pos:0.75, start:0.75, end:0.875}) 
...
CREATE (n15td6ea_luzel16_mei:Event {inputfile: 'luzel16_mei', source:'luzel16.mei' ,id:'n15td6ea' ,type: 'note' ,instrument:'Piano', duration: 0.125, pos:0.875, start:0.875, end:1.0}) 
...
CREATE (n117ty7g_luzel16_mei:Event {inputfile: 'luzel16_mei', source:'luzel16.mei' ,id:'n117ty7g' ,type: 'note' ,instrument:'Piano', duration: 0.125, pos:1.0, start:1.0, end:1.125}) 
...
CREATE (n141j6tl_luzel16_mei:Event {inputfile: 'luzel16_mei', source:'luzel16.mei' ,id:'n141j6tl' ,type: 'note' ,instrument:'Piano', duration: 0.125, pos:1.125, start:1.125, end:1.25}) 
...
CREATE (nlqrkk4_luzel16_mei:Event {inputfile: 'luzel16_mei', source:'luzel16.mei' ,id:'nlqrkk4' ,type: 'note' ,instrument:'Piano', duration: 0.25, pos:1.25, start:1.25, end:1.5}) 
...
CREATE (nlqkf3z_luzel16_mei:Event {inputfile: 'luzel16_mei', source:'luzel16.mei' ,id:'nlqkf3z' ,type: 'note' ,instrument:'Piano', duration: 0.125, pos:1.5, start:1.5, end:1.625}) 
...
CREATE (n1uizrgk_luzel16_mei:Event {inputfile: 'luzel16_mei', source:'luzel16.mei' ,id:'n1uizrgk' ,type: 'note' ,instrument:'Piano', duration: 0.125, pos:1.625, start:1.625, end:1.75}) 
...
CREATE (n13buvim_luzel16_mei:Event {inputfile: 'luzel16_mei', source:'luzel16.mei' ,id:'n13buvim' ,type: 'note' ,instrument:'Piano', duration: 0.125, pos:1.75, start:1.75, end:1.875}) 
...
CREATE (n11s47zf_luzel16_mei:Event {inputfile: 'luzel16_mei', source:'luzel16.mei' ,id:'n11s47zf' ,type: 'note' ,instrument:'Piano', duration: 0.25, pos:1.875, start:1.875, end:2.125}) 
...
CREATE (nwojhz5_luzel16_mei:Event {inputfile: 'luzel16_mei', source:'luzel16.mei' ,id:'nwojhz5' ,type: 'note' ,instrument:'Piano', duration: 0.125, pos:2.125, start:2.125, end:2.25}) 
...
CREATE (n13ghqe2_luzel16_mei:Event {inputfile: 'luzel16_mei', source:'luzel16.mei' ,id:'n13ghqe2' ,type: 'note' ,instrument:'Piano', duration: 0.25, pos:2.25, start:2.25, end:2.5}) 
...
CREATE (n6n0neo_luzel16_mei:Event {inputfile: 'luzel16_mei', source:'luzel16.mei' ,id:'n6n0neo' ,type: 'note' ,instrument:'Piano', duration: 0.125, pos:2.5, start:2.5, end:2.625}) 
...
CREATE (nox37vr_luzel16_mei:Event {inputfile: 'luzel16_mei', source:'luzel16.mei' ,id:'nox37vr' ,type: 'note' ,instrument:'Piano', duration: 0.375, pos:2.625, start:2.625, end:3.0}) 
...
CREATE (n1bflp3d_luzel16_mei:Event {inputfile: 'luzel16_mei', source:'luzel16.mei' ,id:'n1bflp3d' ,type: 'note' ,instrument:'Piano', duration: 0.25, pos:3.0, start:3.0, end:3.25}) 
...
CREATE (nqw6r37_luzel16_mei:Event {inputfile: 'luzel16_mei', source:'luzel16.mei' ,id:'nqw6r37' ,type: 'note' ,instrument:'Piano', duration: 0.125, pos:3.25, start:3.25, end:3.375}) 
...
CREATE (n8s8gs8_luzel16_mei:Event {inputfile: 'luzel16_mei', source:'luzel16.mei' ,id:'n8s8gs8' ,type: 'note' ,instrument:'Piano', duration: 0.125, pos:3.375, start:3.375, end:3.5}) 
...
CREATE (nl68aez_luzel16_mei:Event {inputfile: 'luzel16_mei', source:'luzel16.mei' ,id:'nl68aez' ,type: 'note' ,instrument:'Piano', duration: 0.125, pos:3.5, start:3.5, end:3.625}) 
...
CREATE (n17fq7jd_luzel16_mei:Event {inputfile: 'luzel16_mei', source:'luzel16.mei' ,id:'n17fq7jd' ,type: 'note' ,instrument:'Piano', duration: 0.125, pos:3.625, start:3.625, end:3.75}) 
...
CREATE (nhwopkv_luzel16_mei:Event {inputfile: 'luzel16_mei', source:'luzel16.mei' ,id:'nhwopkv' ,type: 'note' ,instrument:'Piano', duration: 0.25, pos:3.75, start:3.75, end:4.0}) 
...
CREATE (njizd5i_luzel16_mei:Event {inputfile: 'luzel16_mei', source:'luzel16.mei' ,id:'njizd5i' ,type: 'note' ,instrument:'Piano', duration: 0.125, pos:4.0, start:4.0, end:4.125}) 
...
CREATE (n94rkjz_luzel16_mei:Event {inputfile: 'luzel16_mei', source:'luzel16.mei' ,id:'n94rkjz' ,type: 'note' ,instrument:'Piano', duration: 0.125, pos:4.125, start:4.125, end:4.25}) 
...
CREATE (nwa5lbr_luzel16_mei:Event {inputfile: 'luzel16_mei', source:'luzel16.mei' ,id:'nwa5lbr' ,type: 'note' ,instrument:'Piano', duration: 0.125, pos:4.25, start:4.25, end:4.375}) 
...
CREATE (n14uiman_luzel16_mei:Event {inputfile: 'luzel16_mei', source:'luzel16.mei' ,id:'n14uiman' ,type: 'note' ,instrument:'Piano', duration: 0.125, pos:4.375, start:4.375, end:4.5}) 
...
CREATE (nvafp8r_luzel16_mei:Event {inputfile: 'luzel16_mei', source:'luzel16.mei' ,id:'nvafp8r' ,type: 'note' ,instrument:'Piano', duration: 0.25, pos:4.5, start:4.5, end:4.75}) 
...
CREATE (niaaal_luzel16_mei:Event {inputfile: 'luzel16_mei', source:'luzel16.mei' ,id:'niaaal' ,type: 'note' ,instrument:'Piano', duration: 0.125, pos:4.75, start:4.75, end:4.875}) 
...
CREATE (nggfl09_luzel16_mei:Event {inputfile: 'luzel16_mei', source:'luzel16.mei' ,id:'nggfl09' ,type: 'note' ,instrument:'Piano', duration: 0.125, pos:4.875, start:4.875, end:5.0}) 
...
CREATE (n122jjq7_luzel16_mei:Event {inputfile: 'luzel16_mei', source:'luzel16.mei' ,id:'n122jjq7' ,type: 'note' ,instrument:'Piano', duration: 0.125, pos:5.0, start:5.0, end:5.125}) 
...
CREATE (naznien_luzel16_mei:Event {inputfile: 'luzel16_mei', source:'luzel16.mei' ,id:'naznien' ,type: 'note' ,instrument:'Piano', duration: 0.25, pos:5.125, start:5.125, end:5.375}) 
...
CREATE (ns4d4mb_luzel16_mei:Event {inputfile: 'luzel16_mei', source:'luzel16.mei' ,id:'ns4d4mb' ,type: 'note' ,instrument:'Piano', duration: 0.0625, pos:5.375, start:5.375, end:5.4375}) 
...
CREATE (n1c6ymr0_luzel16_mei:Event {inputfile: 'luzel16_mei', source:'luzel16.mei' ,id:'n1c6ymr0' ,type: 'note' ,instrument:'Piano', duration: 0.0625, pos:5.4375, start:5.4375, end:5.5}) 
...
CREATE (n1mvlj5u_luzel16_mei:Event {inputfile: 'luzel16_mei', source:'luzel16.mei' ,id:'n1mvlj5u' ,type: 'note' ,instrument:'Piano', duration: 0.25, pos:5.5, start:5.5, end:5.75}) 
...
CREATE (n19tnxfm_luzel16_mei:Event {inputfile: 'luzel16_mei', source:'luzel16.mei' ,id:'n19tnxfm' ,type: 'note' ,instrument:'Piano', duration: 0.125, pos:5.75, start:5.75, end:5.875}) 
...
CREATE (nz5u3nn_luzel16_mei:Event {inputfile: 'luzel16_mei', source:'luzel16.mei' ,id:'nz5u3nn' ,type: 'note' ,instrument:'Piano', duration: 0.25, pos:5.875, start:5.875, end:6.125}) 
...
CREATE (nzcucq5_luzel16_mei:Event {inputfile: 'luzel16_mei', source:'luzel16.mei' ,id:'nzcucq5' ,type: 'note' ,instrument:'Piano', duration: 0.25, pos:6.125, start:6.125, end:6.375}) 
