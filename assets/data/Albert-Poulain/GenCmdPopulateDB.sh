...
find "$PWD" -type f -name "*.cypher" > list_of_files_temp.txt;
...
sed "s/\/Users\/thion\/SVNSourceSup\/skrid\/DSLData\/Data/\/home\/shaman\/Public\/DSL\/SKRIDPlatform\/assets\/data/g" cmdPopulate.cql > cmdPopulate_Elaine.cql
