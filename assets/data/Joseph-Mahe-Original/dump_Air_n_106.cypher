...
CREATE (fact0_Air_n_106_mei:Fact {inputfile: 'Air_n_106_mei', source:'Air_n_106.mei', id: 'fact0',type: 'note', pname:'a', class:'a', octave:4, name:'A4', dur:8,instrument:'Piano'}) 
...
CREATE (fact1_Air_n_106_mei:Fact {inputfile: 'Air_n_106_mei', source:'Air_n_106.mei', id: 'fact1',type: 'note', pname:'a', class:'a', octave:4, name:'A4', dur:16,instrument:'Piano'}) 
...
CREATE (fact2_Air_n_106_mei:Fact {inputfile: 'Air_n_106_mei', source:'Air_n_106.mei', id: 'fact2',type: 'note', pname:'b', class:'b', octave:4, name:'B4', dur:16,instrument:'Piano'}) 
...
CREATE (fact3_Air_n_106_mei:Fact {inputfile: 'Air_n_106_mei', source:'Air_n_106.mei', id: 'fact3',type: 'note', pname:'c', class:'c', octave:5, name:'C5', dur:8,instrument:'Piano'}) 
...
CREATE (fact4_Air_n_106_mei:Fact {inputfile: 'Air_n_106_mei', source:'Air_n_106.mei', id: 'fact4',type: 'note', pname:'d', class:'d', octave:5, name:'D5', dur:8,instrument:'Piano'}) 
...
CREATE (fact5_Air_n_106_mei:Fact {inputfile: 'Air_n_106_mei', source:'Air_n_106.mei', id: 'fact5',type: 'note', pname:'a', class:'a', octave:4, name:'A4', dur:8,instrument:'Piano'}) 
...
CREATE (fact6_Air_n_106_mei:Fact {inputfile: 'Air_n_106_mei', source:'Air_n_106.mei', id: 'fact6',type: 'note', pname:'g', class:'g', octave:4, name:'G4', dur:8,instrument:'Piano'}) 
...
CREATE (fact7_Air_n_106_mei:Fact {inputfile: 'Air_n_106_mei', source:'Air_n_106.mei', id: 'fact7',type: 'note', pname:'a', class:'a', octave:4, name:'A4', dur:8,instrument:'Piano'}) 
...
CREATE (fact8_Air_n_106_mei:Fact {inputfile: 'Air_n_106_mei', source:'Air_n_106.mei', id: 'fact8',type: 'note', pname:'a', class:'a', octave:4, name:'A4', dur:16,instrument:'Piano'}) 
...
CREATE (fact9_Air_n_106_mei:Fact {inputfile: 'Air_n_106_mei', source:'Air_n_106.mei', id: 'fact9',type: 'note', pname:'b', class:'b', octave:4, name:'B4', dur:16,instrument:'Piano'}) 
...
CREATE (fact10_Air_n_106_mei:Fact {inputfile: 'Air_n_106_mei', source:'Air_n_106.mei', id: 'fact10',type: 'note', pname:'c', class:'c', octave:5, name:'C5', dur:8,instrument:'Piano'}) 
...
CREATE (fact11_Air_n_106_mei:Fact {inputfile: 'Air_n_106_mei', source:'Air_n_106.mei', id: 'fact11',type: 'note', pname:'d', class:'d', octave:5, name:'D5', dur:8,instrument:'Piano'}) 
...
CREATE (fact12_Air_n_106_mei:Fact {inputfile: 'Air_n_106_mei', source:'Air_n_106.mei', id: 'fact12',type: 'note', pname:'a', class:'a', octave:4, name:'A4', dur:4,instrument:'Piano'}) 
...
CREATE (fact13_Air_n_106_mei:Fact {inputfile: 'Air_n_106_mei', source:'Air_n_106.mei', id: 'fact13',type: 'note', pname:'a', class:'a', octave:4, name:'A4', dur:8,instrument:'Piano'}) 
...
CREATE (fact14_Air_n_106_mei:Fact {inputfile: 'Air_n_106_mei', source:'Air_n_106.mei', id: 'fact14',type: 'note', pname:'a', class:'a', octave:4, name:'A4', dur:16,instrument:'Piano'}) 
...
CREATE (fact15_Air_n_106_mei:Fact {inputfile: 'Air_n_106_mei', source:'Air_n_106.mei', id: 'fact15',type: 'note', pname:'a', class:'a', octave:4, name:'A4', dur:16,instrument:'Piano'}) 
...
CREATE (fact16_Air_n_106_mei:Fact {inputfile: 'Air_n_106_mei', source:'Air_n_106.mei', id: 'fact16',type: 'note', pname:'a', class:'a', octave:4, name:'A4', dur:8,instrument:'Piano'}) 
...
CREATE (fact17_Air_n_106_mei:Fact {inputfile: 'Air_n_106_mei', source:'Air_n_106.mei', id: 'fact17',type: 'note', pname:'a', class:'a', octave:4, name:'A4', dur:8,instrument:'Piano'}) 
...
CREATE (fact18_Air_n_106_mei:Fact {inputfile: 'Air_n_106_mei', source:'Air_n_106.mei', id: 'fact18',type: 'note', pname:'g', class:'g', octave:4, name:'G4', dur:8,instrument:'Piano'}) 
...
CREATE (fact19_Air_n_106_mei:Fact {inputfile: 'Air_n_106_mei', source:'Air_n_106.mei', id: 'fact19',type: 'note', pname:'f', class:'f', octave:4, name:'F4', dur:8,instrument:'Piano'}) 
...
CREATE (fact20_Air_n_106_mei:Fact {inputfile: 'Air_n_106_mei', source:'Air_n_106.mei', id: 'fact20',type: 'note', pname:'g', class:'g', octave:4, name:'G4', dur:8,instrument:'Piano'}) 
...
CREATE (fact21_Air_n_106_mei:Fact {inputfile: 'Air_n_106_mei', source:'Air_n_106.mei', id: 'fact21',type: 'note', pname:'f', class:'f', octave:4, name:'F4', dur:16,instrument:'Piano'}) 
...
CREATE (fact22_Air_n_106_mei:Fact {inputfile: 'Air_n_106_mei', source:'Air_n_106.mei', id: 'fact22',type: 'note', pname:'e', class:'e', octave:4, name:'E4', dur:16,instrument:'Piano'}) 
...
CREATE (fact23_Air_n_106_mei:Fact {inputfile: 'Air_n_106_mei', source:'Air_n_106.mei', id: 'fact23',type: 'note', pname:'d', class:'d', octave:4, name:'D4', dur:8,instrument:'Piano'}) 
...
CREATE (fact24_Air_n_106_mei:Fact {inputfile: 'Air_n_106_mei', source:'Air_n_106.mei', id: 'fact24',type: 'note', pname:'d', class:'d', octave:4, name:'D4', dur:16,instrument:'Piano'}) 
...
CREATE (fact25_Air_n_106_mei:Fact {inputfile: 'Air_n_106_mei', source:'Air_n_106.mei', id: 'fact25',type: 'note', pname:'e', class:'e', octave:4, name:'E4', dur:16,instrument:'Piano'}) 
...
CREATE (fact26_Air_n_106_mei:Fact {inputfile: 'Air_n_106_mei', source:'Air_n_106.mei', id: 'fact26',type: 'note', pname:'f', class:'f', octave:4, name:'F4', dur:8,instrument:'Piano'}) 
...
CREATE (fact27_Air_n_106_mei:Fact {inputfile: 'Air_n_106_mei', source:'Air_n_106.mei', id: 'fact27',type: 'note', pname:'g', class:'g', octave:4, name:'G4', dur:8,instrument:'Piano'}) 
...
CREATE (fact28_Air_n_106_mei:Fact {inputfile: 'Air_n_106_mei', source:'Air_n_106.mei', id: 'fact28',type: 'note', pname:'a', class:'a', octave:4, name:'A4', dur:8,instrument:'Piano'}) 
...
CREATE (fact29_Air_n_106_mei:Fact {inputfile: 'Air_n_106_mei', source:'Air_n_106.mei', id: 'fact29',type: 'note', pname:'a', class:'a', octave:4, name:'A4', dur:16,instrument:'Piano'}) 
...
CREATE (fact30_Air_n_106_mei:Fact {inputfile: 'Air_n_106_mei', source:'Air_n_106.mei', id: 'fact30',type: 'note', pname:'a', class:'a', octave:4, name:'A4', dur:16,instrument:'Piano'}) 
...
CREATE (fact31_Air_n_106_mei:Fact {inputfile: 'Air_n_106_mei', source:'Air_n_106.mei', id: 'fact31',type: 'note', pname:'a', class:'a', octave:4, name:'A4', dur:8,instrument:'Piano'}) 
...
CREATE (fact32_Air_n_106_mei:Fact {inputfile: 'Air_n_106_mei', source:'Air_n_106.mei', id: 'fact32',type: 'note', pname:'a', class:'a', octave:4, name:'A4', dur:8,instrument:'Piano'}) 
...
CREATE (fact33_Air_n_106_mei:Fact {inputfile: 'Air_n_106_mei', source:'Air_n_106.mei', id: 'fact33',type: 'note', pname:'g', class:'g', octave:4, name:'G4', dur:8,instrument:'Piano'}) 
...
CREATE (fact34_Air_n_106_mei:Fact {inputfile: 'Air_n_106_mei', source:'Air_n_106.mei', id: 'fact34',type: 'note', pname:'f', class:'f', octave:4, name:'F4', dur:8,instrument:'Piano'}) 
...
CREATE (fact35_Air_n_106_mei:Fact {inputfile: 'Air_n_106_mei', source:'Air_n_106.mei', id: 'fact35',type: 'note', pname:'g', class:'g', octave:4, name:'G4', dur:8,instrument:'Piano'}) 
...
CREATE (fact36_Air_n_106_mei:Fact {inputfile: 'Air_n_106_mei', source:'Air_n_106.mei', id: 'fact36',type: 'note', pname:'g', class:'g', octave:4, name:'G4', dur:16,instrument:'Piano'}) 
...
CREATE (fact37_Air_n_106_mei:Fact {inputfile: 'Air_n_106_mei', source:'Air_n_106.mei', id: 'fact37',type: 'note', pname:'g', class:'g', octave:4, name:'G4', dur:16,instrument:'Piano'}) 
...
CREATE (fact38_Air_n_106_mei:Fact {inputfile: 'Air_n_106_mei', source:'Air_n_106.mei', id: 'fact38',type: 'note', pname:'g', class:'g', octave:4, name:'G4', dur:8,instrument:'Piano'}) 
...
CREATE (fact39_Air_n_106_mei:Fact {inputfile: 'Air_n_106_mei', source:'Air_n_106.mei', id: 'fact39',type: 'note', pname:'e', class:'e', octave:4, name:'E4', dur:8,instrument:'Piano'}) 
...
CREATE (fact40_Air_n_106_mei:Fact {inputfile: 'Air_n_106_mei', source:'Air_n_106.mei', id: 'fact40',type: 'note', pname:'d', class:'d', octave:4, name:'D4', dur:4,instrument:'Piano'}) 
